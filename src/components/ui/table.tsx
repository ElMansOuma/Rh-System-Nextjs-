...
export const TableColumn: React.FC<React.ThHTMLAttributes<HTMLTableHeaderCellElement>> = ({ children, className, ...props }) => (
  <th
    className={cn('px-4 py-3 text-sm font-semibold text-gray-600', className)}
    {...props}
  >
    {children}
  </th>
